...
GLuint terrainProgram, phongProgram;
GLuint tex1, tex2;
...
void loadModels() { groundSphereModel = LoadModelPlus("groundsphere.obj"); }
...
void init(void) {
  ...
  glUniform1i(glGetUniformLocation(terrainProgram, "tex"),
              0);  // Texture unit 0
  glUniform1i(glGetUniformLocation(terrainProgram, "texBlend"),
              1);  // Texture unit 1
  LoadTGATextureSimple("maskros512.tga", &tex1);
  LoadTGATextureSimple("white.tga", &tex2);

  // Load terrain data

  LoadTGATextureData("44-terrain-big.tga", &ttex);
